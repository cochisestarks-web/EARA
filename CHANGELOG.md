...
### Added
- Intro section explaining gamma and the Darwish framework for new visitors
- Collapsible glossary panel defining all 8 core simulation terms
...
- Consolidated project files from multiple folders into single repository
...
### Added
- Shareable schedule links via Base64 URL encoding
- Auto-load schedules from URL on page load
- Clipboard copy functionality for share URLs
